...
namespace Game4Freak.AdvancedZones
{
    public class CommandZone : IRocketCommand
    {
        ...
        public void Execute(IRocketPlayer caller, params string[] command)
        {
            ...
            string commandEntry = command[0].ToLower();
            Zone currentZone;
            string message;
            switch (commandEntry)
            {
                case "add":
                    ...
                    else if (command[1].ToLower() == "zone")
                    {
                        ...
                        foreach (var z in AdvancedZones.Inst.Configuration.Instance.Zones)
                        {
                        ...
                        AdvancedZones.Inst.Configuration.Instance.Zones.Add(new Zone(command[2]));
                    ...
                    else if (command[1].ToLower() == "node")
                    {
                        ...
                        currentZone = AdvancedZones.Inst.getZoneByName(command[2]);
                        if (currentZone != null)
                        {
                    ...
                    else if (command[1].ToLower() == "flag")
                    {
                        ...
                        for (int i = 0; i < AdvancedZones.Inst.Configuration.Instance.CustomFlags.Count; i++)
                        {
                            if (command[3].ToLower() == AdvancedZones.Inst.Configuration.Instance.CustomFlags[i].name.ToLower())
                            {
                                currentZone = AdvancedZones.Inst.getZoneByName(command[2]);
                                if (currentZone != null)
                                {
                                    if (currentZone.hasFlag(AdvancedZones.Inst.Configuration.Instance.CustomFlags[i].name))
                                    {
                                        UnturnedChat.Say(caller, "The zone: " + command[2] + " already has the flag: " + Zone.flagTypes[i], UnityEngine.Color.red);
                                        return;
                                    }
                                    currentZone.addFlag(AdvancedZones.Inst.Configuration.Instance.CustomFlags[i].name);
                                    UnturnedChat.Say(caller, "Added flag " + AdvancedZones.Inst.Configuration.Instance.CustomFlags[i].name + " to zone: " + currentZone.getName(), UnityEngine.Color.cyan);
                                    AdvancedZones.Inst.Configuration.Save();
                                    return;
                                }
                                else
                        ...
                        message = "Invalid! Try flags: ";
                        for (int i = 0; i < Zone.flagTypes.Length; i++)
                        {
                            message = message + Zone.flagTypes[i] + ", ";
                        }
                        foreach (var customFlag in AdvancedZones.Inst.Configuration.Instance.CustomFlags)
                        {
                    ...
                    else if (command[1].ToLower() == "block")
                    {
                        ...
                        if (currentZone != null)
                        {
                            ...
                            {
                                foreach (var blockList in AdvancedZones.Inst.Configuration.Instance.EquipBlocklists)
                                {
                            ...
                            {
                                foreach (var blockList in AdvancedZones.Inst.Configuration.Instance.BuildBlocklists)
                                {
                                    if (blockList.name.ToLower() == command[4].ToLower())
                                    {
                ...
                case "remove":
                    ...
                    else if (command[1].ToLower() == "zone")
                    {
                        ...
                        if (currentZone != null)
                        {
                            ...
                            AdvancedZones.Inst.Configuration.Instance.Zones.RemoveAt(AdvancedZones.Inst.Configuration.Instance.Zones.IndexOf(currentZone));
                            AdvancedZones.Inst.Configuration.Save();
                            return;
                        }
                        else
                        ...
                        for (int i = 0; i < AdvancedZones.Inst.Configuration.Instance.CustomFlags.Count; i++)
                        {
                            if (command[3].ToLower() == AdvancedZones.Inst.Configuration.Instance.CustomFlags[i].name.ToLower())
                            {
                                ...
                                if (currentZone != null)
                                {
                                    if (currentZone.hasFlag(AdvancedZones.Inst.Configuration.Instance.CustomFlags[i].name))
                                    {
                                        currentZone.removeFlag(AdvancedZones.Inst.Configuration.Instance.CustomFlags[i].name);
                                        AdvancedZones.Inst.Configuration.Save();
                                        UnturnedChat.Say(caller, "Removed flag " + AdvancedZones.Inst.Configuration.Instance.CustomFlags[i].name + " from zone: " + currentZone.name, UnityEngine.Color.cyan);
                                        return;
                                    }
                                    UnturnedChat.Say(caller, "The zone: " + currentZone.getName() + " does not has the flag: " + AdvancedZones.Inst.Configuration.Instance.CustomFlags[i].name, UnityEngine.Color.red);
                                    return;
                                }
                                else
                                {
                ...
                case "list":
                    ...
                    else if (command[1].ToLower() == "nodes")
                    {
                        ...
                        if (currentZone != null)
                        {
                            message = "Nodes of zone: " + currentZone.getName() + ": ";
                            for (int i = 0; i < currentZone.getNodes().Length; i++)
                            {
                                message = message + "(" + i + ") x:" + currentZone.getNodes()[i].x + " z: " + currentZone.getNodes()[i].z + ", ";
                            }
                    ...
                    else if (command[1].ToLower() == "flags")
                    {
                        ...
                        if (currentZone != null)
                        {
                            message = "Flags of zone: " + currentZone.getName() + ": ";
                            foreach (var f in currentZone.getFlags())
                            {
                                message = message + f + ", ";
                            }
                    ...
                    else if (command[1].ToLower() == "blocklists")
                    {
                        ...
                        if (currentZone != null)
                        {
                            message = "BlockLists of zone: " + currentZone.getName() + ": Equip{";
                    ...
                    else if (command[1].ToLower() == "groups")
                    {
                        ...
                        if (currentZone != null)
                        {
                            message = "Groups of zone: " + currentZone.getName() + ": Enter{Add{";
                            foreach (var enterAddGroup in currentZone.getEnterAddGroups())
                            {
                    ...
                    else if (command[1].ToLower() == "parameters")
                    {
                        ...
                        if (currentZone != null)
                        {
                            message = "Parameters of zone: " + currentZone.getName() + ": ";
                            foreach (var parameter in currentZone.GetParameters())
                            {
                    ...
                    else if (command[1].ToLower() == "heightnodes")
                    {
                        ...
                        if (currentZone != null)
                        {
                            message = "HeightNodes of zone: " + currentZone.getName() + ": ";
                    ...
                    else if (command[1].ToLower() == "effects")
                    {
                        ...
                        if (currentZone != null)
                        {
                            message = "Effects of zone: " + currentZone.getName() + ": Enter{Add{";
                            foreach (var enterAddEffect in currentZone.getEnterAddEffects())
                            {
                ...
                case "inzone":
                    #region InZone
                    message = "You are in the zones: ";
                    foreach (var z in AdvancedZones.Inst.getPositionZones(player.Position))
                    {
                ...
                case "blocklist":
                    ...
                    if (command[1].ToLower() == "add")
                    {
                        if (command[2].ToLower() == "equip")
                        {
                            ...
                            foreach (var equipBlocklist in AdvancedZones.Inst.Configuration.Instance.EquipBlocklists)
                            {
                            ...
                            AdvancedZones.Inst.Configuration.Instance.EquipBlocklists.Add(new EquipBlocklist(command[3]));
                            AdvancedZones.Inst.Configuration.Save();
                        ...
                        else if (command[2].ToLower() == "build")
                        {
                            ...
                            foreach (var buildBlocklist in AdvancedZones.Inst.Configuration.Instance.BuildBlocklists)
                            {
                            ...
                            AdvancedZones.Inst.Configuration.Instance.BuildBlocklists.Add(new BuildBlocklist(command[3]));
                            AdvancedZones.Inst.Configuration.Save();
                            UnturnedChat.Say(caller, "Added BlockList: " + command[3], UnityEngine.Color.cyan);
                            return;
                        }
                        ...
                        if (command[2].ToLower() == "equip")
                        {
                            ...
                            foreach (var equipBlocklist in AdvancedZones.Inst.Configuration.Instance.EquipBlocklists)
                            {
                                if (equipBlocklist.name.ToLower() == command[3].ToLower())
                                {
                                    ...
                                    AdvancedZones.Inst.Configuration.Instance.EquipBlocklists.Remove(equipBlocklist);
                                    AdvancedZones.Inst.Configuration.Save();
                                    return;
                                }
                            }
                        ...
                        else if (command[2].ToLower() == "build")
                        {
                            ...
                            foreach (var buildBlocklist in AdvancedZones.Inst.Configuration.Instance.BuildBlocklists)
                            {
                                if (buildBlocklist.name.ToLower() == command[3].ToLower())
                                {
                                    ...
                                    AdvancedZones.Inst.Configuration.Instance.BuildBlocklists.Remove(buildBlocklist);
                                    AdvancedZones.Inst.Configuration.Save();
                                    return;
                                }
                            }
